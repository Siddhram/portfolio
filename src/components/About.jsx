        ...
        >
          <div className='flex justify-center lg:justify-start'>
            <p className='my-2 max-w-xl py-6'>
              I am a software engineer passionate about building applications that truly help users solve their problems. My expertise lies in developing innovative, user-focused solutions using technologies like Flutter and the MERN stack. I’ve worked on a range of projects, from real-time chat applications to AI-powered tools, including a virtual legal assistant for the Department of Justice.
              <br />
